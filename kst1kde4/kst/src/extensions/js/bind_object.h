...
class KstBindObject : public KstBinding {
  public:
    ...
    /* @property string fullTagName
       @readonly
       @description The unique contextual identifier for this data object, contained with [...].
     */
    KJS::Value fullTagName(KJS::ExecState *exec) const;
