...
KJS::Value KstBindCurveCollection::prepend(KJS::ExecState *exec, const KJS::List& args) {
  Q_UNUSED(exec)
  Q_UNUSED(args)

  createGeneralError(exec, i18n("The prepend method is not supported for this collection."));
