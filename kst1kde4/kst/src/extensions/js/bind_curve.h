...
class KstBindCurve : public KstBindDataObject {
  public:
    ...
    */
    /* @constructor
       @description Constructor for Curve class.  Allows a curve to be simply created from a Histogram class.
       @arg Histogram hs Creates a curve from a histogram.
    */
    ...
    */
    ...
    /* @method xErrorPoint
       @returns number
       @description Retrieve the value for a given point in the X error
    ...
    */
    ...
    /* @method yErrorPoint
       @returns number
       @description Retrieve the value for a given point in the Y error
                    bars.  Returns an invalid point if that index does not
                    exist.
       @arg number index The index of the point to retrieve the coordinates
                         for. Starts at 0.
    */
    ...
    /* @method xMinusErrorPoint
       @returns number
       @description Retrieve the value for a given point in the X minus
    ...
    */
    ...
    /* @method yMinusErrorPoint
       @returns number
       @description Retrieve the value for a given point in the Y minus
                    error bars.  Returns an invalid point if that index does
                    not exist.
       @arg number index The index of the point to retrieve the coordinates
                         for. Starts at 0.
    ...
    */
    ...
    /* @property Scalar yVectorOffset
       @description The offset to be applied to the y-axis vector.
    */
    void setYVectorOffset(KJS::ExecState *exec, const KJS::Value& value);
    KJS::Value yVectorOffset(KJS::ExecState *exec) const;
    ...
    */
    ...
    /* @property string legendText
       @description The legend text associated with a curve.
    */
    void setLegendText(KJS::ExecState *exec, const KJS::Value& value);
    KJS::Value legendText(KJS::ExecState *exec) const;
