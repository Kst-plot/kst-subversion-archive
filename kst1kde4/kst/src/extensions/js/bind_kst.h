  ...
  public:
    ...
    */
    ...
    /* @method waitForUpdate
       @description Waits for the next update loop to complete.
    */
    KJS::Value waitForUpdate(KJS::ExecState *exec, const KJS::List& args);
    ...
    */
    KJS::Value advance(KJS::ExecState *exec, const KJS::List& args);

    /* @method back
       @description Back one screen.
    */
    KJS::Value back(KJS::ExecState *exec, const KJS::List& args);

    /* @method writeHistory
       @arg string filename The name of the file to save the command history to.
       @description Saves the command history to a file.
    */
    KJS::Value writeHistory(KJS::ExecState *exec, const KJS::List& args);

    /* @method clearHistory
       @description Clears the command history.
    */
    KJS::Value clearHistory(KJS::ExecState *exec, const KJS::List& args);

    /* @method addToOutput
       @arg string output String to add to the output.
       @description Adds to the output generated from a function call.
    */
    KJS::Value addToOutput(KJS::ExecState *exec, const KJS::List& args);
    ...
    */
    ...
    /* @property MatrixCollection matrices
       @readonly
       @description The list of all matrices in Kst.
    */
    KJS::Value matrices(KJS::ExecState *exec) const;
