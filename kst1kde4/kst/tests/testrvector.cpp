...
void testAscii() {
...

  {
    ...
    doTest(rvp->value()[0] == 100.0);
    doTest(rvp->value()[1] == 110.0);
    doTest(rvp->value()[2] == 120.0);
    doTest(rvp->value()[3898] == 39080.0);
...
int main(int argc, char **argv) {
  ...
  KCmdLineArgs::init(argc, argv, "testrvector", "testrvector", "testrvector", "1.0.0.0");
