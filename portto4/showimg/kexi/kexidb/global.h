...
//#define KexiDBDbg  kdDebug(0)   //! Debug area for core KexiDB code
//#define KexiDBDrvDbg kdDebug(0) //! Debug area for KexiDB's drivers implementation code
//#define KexiDBWarn  kdWarning(0)
//#define KexiDBDrvWarn kdWarning(0)
