...
class SHOWIMGCORE_EXPORT DMetadata
{
...
public:
    ...
    DMetadata(const QString& filePath, const QString& ff="NONE");

    bool applyChanges();

    /** File access method */
    bool load(const QString& filePath, const QString& ff);
    bool save(const QString& filePath, const QString& fileFormat);
