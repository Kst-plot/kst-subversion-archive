...
// 	MYDEBUG<<osdText<<endl;
	OSDWidget::setText(osdText);
	if(m_dispOSD && ! osdText.isEmpty())
	{
		if(m_onTop)
		{
			MYDEBUG<<parentWidget()->mapToGlobal(QPoint(0,0))<<endl;
