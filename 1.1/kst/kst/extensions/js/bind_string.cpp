...
: KstBinding("String") {
  ...
  addBindings(exec, o);
  if (globalObject) {
    globalObject->put(exec, "String", o);
  } else {
    _s = new KstString;
  }
}
...
static StringProperties stringProperties[] = {
  { "tagName", &KstBindString::setTagName, &KstBindString::tagName },
...
void KstBindString::setValue(KJS::ExecState *exec, const KJS::Value& value) {
  ...
  _s->setValue(value.toString(exec).qstring());
}
...
KJS::Value KstBindString::value(KJS::ExecState *exec) const {
  Q_UNUSED(exec)
  KstReadLocker rl(_s);
  return KJS::String(_s->value());
}


void KstBindString::setTagName(KJS::ExecState *exec, const KJS::Value& value) {
...
KJS::Value KstBindString::tagName(KJS::ExecState *exec) const {
  Q_UNUSED(exec)
  KstReadLocker rl(_s);
