...
class CHexViewWidget : public QFrame
{
  ...
  public:
    ...
    //gmbertani virtualized for serlook
    virtual int  readFile( QFile &file, const QString &url, CProgress &p );
...
//gbertani protected instead of private
//for serlook purposes
protected: 
    void setSelection( uint offset, bool init );
    
    //gbertani virtualized
    //for serlook purposes
    virtual void setCursorPosition( int x, int y, bool init, bool cellLevel );
