...
#else // HAVE_LIBEXIV2
#if IMALOADER_DEBUG_THREAD > 0
				MYDEBUG<<"DMetadata l_exif_data(l_image_fileinfo.absFilePath ())="<<l_image_fileinfo.absFilePath ()<<endl;
#endif
				DMetadata l_exif_data(l_image_fileinfo.absFilePath (), KImageIO::type(l_image_fileinfo.absFilePath ()));
