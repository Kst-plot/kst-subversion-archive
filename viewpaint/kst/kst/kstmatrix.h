...
class KST_EXPORT KstMatrix: public KstObject {
  Q_OBJECT
  public:
    // Matrices do not automatically add themselves to the global matrix list
    KstMatrix(const QString &in_tag = QString::null, uint nX = 1, uint nY = 0, 
    ...
    // provider of this matrix
    KstObjectPtr provider() const;
  ...
  protected:
    ...
    bool _editable : 1;
    bool _saveable : 1;
    QGuardedPtr<KstObject> _provider; // provider of this matrix; may be null
