...
typedef QValueList<EventMonitorEntry>	EventMonitors;
...
public:
  ...
  /** Return the list of event monitors for a given vector */
  EventMonitors* getEventMonitors() { return &_eventMonitors; }
    
  /** Set the list of event monitors for a given vector */
