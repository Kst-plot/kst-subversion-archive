...
: KstCurveDialog(parent, name, modal, fl) {
  ...
  connect(_xVector, SIGNAL(newVectorCreated(const QString&)), this, SIGNAL(modified()));
  connect(_yVector, SIGNAL(newVectorCreated(const QString&)), this, SIGNAL(modified()));
  connect(_xError, SIGNAL(newVectorCreated(const QString&)), this, SIGNAL(modified()));
  connect(_yError, SIGNAL(newVectorCreated(const QString&)), this, SIGNAL(modified()));
